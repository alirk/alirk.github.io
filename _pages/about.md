...
======
<img style="float: left;" src="/images/LS.png" width="320"/>  We have introduced a method to **minimize overall true risk** in distributed learning environments under **label shift** conditions. We improve test-to-train density ratio estimation through Shannon entropy-based regularization. This regularization leads to more accurate estimation of the test-to-train label density probabilities and  **achieves a 20% improvement in average test error** compared to baselines in imbalanced settings approaching the upper-bound.
